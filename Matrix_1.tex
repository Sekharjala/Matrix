...
%
\begin{lstlisting}
https://github.com/Sekharjala/Matrix/Assignment1
\end{lstlisting}
%
...
\end{align}
Let us assume that $\vec{A}$ and $\vec{B}$ are the vectors having real elements  a=0,b=1,c=2 then\\
\begin{align}
\vec{A}=\myvec{3\\2}   \nonumber\\   
\vec{B}=\myvec{2\\1}   \nonumber\\
\norm{\vec{A}-\vec{B}}&=\sqrt{1+1} \nonumber\\
\norm{\vec{A}-\vec{B}}&=\sqrt{2} \nonumber\\
&=1.414 \nonumber
\end{align}
\begin{figure}[!h]
\includegraphics[width=\columnwidth]{Matrix_1.png}
